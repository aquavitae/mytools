...
CREATE DATABASE "\\nbi-srv\C:\Lisemma\NBI_PFD.GDB" PAGE_SIZE 4096
;
...
/* Domain definitions */
CREATE DOMAIN STD_MEMO AS BLOB SUB_TYPE TEXT SEGMENT SIZE 80;
CREATE DOMAIN STD_MONEY AS NUMERIC(15, 2);
...
CREATE TABLE PROJECT (R_OFFICE CHAR(5) NOT NULL,
        ...
        LOCATION STD_MEMO NOT NULL,
        DESCRIPTION STD_MEMO,
        DISTANCE SMALLINT,
